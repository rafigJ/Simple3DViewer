...
public class ObjReader {
	...
	protected static Vector3 parseVertex(final List<String> listOfWordsWithoutToken, final int lineInd) {
	...
	protected static Vector2 parseTextureVertex(final List<String> listOfWordsWithoutToken, final int lineInd) {
	...
	protected static Vector3 parseNormal(final List<String> listOfWordsWithoutToken, final int lineInd) {
		if (listOfWordsWithoutToken.size() != 3)
